...
/**
 * @access private
 * @description removes a post from stories for a given user
 * @route POST /api/v1/posts/remove-story/:post_uuid
 */
export const removeStory = asyncHandler(
  async (req: AuthRequest, res: Response) => {
    ...
    const result = await postService.removeStory(user as any, post_uuid);
